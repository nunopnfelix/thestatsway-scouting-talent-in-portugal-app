...
if page == "Instructions & Abbreviations":
    ...
    - **Player Progression in a Team:** Review and analyze a player’s trajectory in the same team from the 2024/25 season to the 2025/26 season.
             """)
    st.write("""---""")
